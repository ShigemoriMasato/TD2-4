...
void SHEngine::Text::Initialize(const std::string& fontPath, int fontSize) {
...
void SHEngine::Text::Update(float deltaTime, Matrix4x4 vpMat) {
	wvpMat_ = charSizeMat_ * worldMat_ * vpMat;

	Matrix4x4 mat[2] = { wvpMat_, worldMat_ };
