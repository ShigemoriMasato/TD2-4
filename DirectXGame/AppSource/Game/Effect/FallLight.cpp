...
void FallLight::Initialize(const SHEngine::DrawData& drawData, SHEngine::TextureManager* textureManager, Camera* camera) {
	renderObject_ = std::make_unique<SHEngine::RenderObject>("FallLight");
	...
	renderObject_->psoConfig_.depthStencilID = SHEngine::PSO::DepthStencilID::Transparent;
	renderObject_->psoConfig_.blendID = SHEngine::PSO::BlendStateID::Add;
...
void FallLight::Draw(CmdObj* cmdObj) {
