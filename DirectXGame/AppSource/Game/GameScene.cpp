...
GameScene::GameScene() {
	...
	gameMonitor_ = std::make_unique<SHEngine::RenderObject>("GameMonitor");
...
void GameScene::Initialize() {
	...
	SHEngine::DrawData drawData = drawDataManager_->GetDrawData(model.drawDataIndex);
	...
	gameMonitor_->psoConfig_.depthStencilID = SHEngine::PSO::DepthStencilID::Transparent;
	...
	gameOverText = std::make_unique<SHEngine::RenderObject>("GameOverText");
...
void GameScene::Draw() {
	...
	backGround_->Draw(cmdObj);
	tetris_->Draw(cmdObj);
	fallLight_->Draw(cmdObj);
