...
void ShigeScene::Initialize() {
	...
	pauseText_ = std::make_unique<SHEngine::Text>(32);
	pauseText_->Initialize(planeDrawData, fontPath_, 32);
	pauseText_->SetColor({1.0f, 1.0f, 1.0f, 1.0f});
	pauseText_->SetText(L"ポーズ");

	pauseTextTransform_.position = {130.0f, -660.0f, 0.0f};
	pauseTextTransform_.scale = {2.0f, 2.0f, 1.0f};
